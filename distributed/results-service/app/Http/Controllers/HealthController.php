...
class HealthController extends Controller
{
    ...
    protected function checkDatabase(): array
    {
        try {
            ...
            // Test table access
            $standingsCount = DB::table('standings')->count();
            $matchResultsCount = DB::table('match_results')->count();
    ...
    protected function checkQueue(): array
    {
        try {
            ...
            return [
                ...
                'worker_status' => 'running', // This would require actual worker monitoring
            ];
        } catch (\Exception $e) {
