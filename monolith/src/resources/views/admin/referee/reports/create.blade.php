...
<div class="max-w-10xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold">Create Match Report</h1>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="{{ route('admin.referee.reports.store', $match) }}" method="POST">
            @csrf
            ...
            <div class="mb-6">
                ...
                <textarea
                    ...
                    placeholder="Provide a detailed summary of the match including key moments, player performances, and any notable incidents...">{{ old('summary') }}</textarea>
                @error('summary')
            ...
            <div class="mb-6">
                ...
                @error('referee')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
                <p class="mt-1 text-sm text-gray-500">Defaults to your name if left empty</p>
            </div>
