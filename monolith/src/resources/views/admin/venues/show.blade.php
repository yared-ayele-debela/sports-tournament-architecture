    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-1">Venue details and information</p>
            </div>
            <div class="flex items-center space-x-3">
                ...
                <a href="{{ route('admin.venues.edit', $venue->id) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="p-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <dl class="space-y-3">
                            <div class="flex justify-between py-2 border-b border-gray-200">
                                ...
                                <dd class="text-sm text-gray-900 font-medium">{{ $venue->name }}</dd>
                            </div>
                            <div class="flex justify-between py-2 border-b border-gray-200">
                                <dt class="text-sm font-medium text-gray-500">Location</dt>
                                <dd class="text-sm text-gray-900 font-medium">{{ $venue->location }}</dd>
                            </div>
                            <div class="flex justify-between py-2">
                                <dt class="text-sm font-medium text-gray-500">Capacity</dt>
                                <dd class="text-sm text-gray-900 font-medium">
                                    {{ $venue->capacity ? number_format($venue->capacity) : 'Not specified' }}
                                </dd>
                            </div>
                        </dl>
                    </div>
                ...
                <div class="space-y-6">
                    <div>
                        <h3 class="text-lg font-medium text-gray-900 mb-4">Venue Statistics</h3>
                        <dl class="space-y-3">
                            <div class="flex justify-between py-2 border-b border-gray-200">
                                <dt class="text-sm font-medium text-gray-500">Created</dt>
                                <dd class="text-sm text-gray-900 font-medium">{{ $venue->created_at->format('F j, Y H:i') }}</dd>
                            </div>
                            <div class="flex justify-between py-2">
                                <dt class="text-sm font-medium text-gray-500">Last Updated</dt>
                                <dd class="text-sm text-gray-900 font-medium">{{ $venue->updated_at->format('F j, Y H:i') }}</dd>
                            </div>
                        </dl>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <a href="{{ route('admin.venues.edit', $venue->id) }}" class="block w-full text-center px-4 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors">
