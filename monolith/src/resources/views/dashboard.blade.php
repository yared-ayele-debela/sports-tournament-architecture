<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Sports Tournament Dashboard') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6">
                    <div class="mb-6">
                        ...
                        <p class="text-gray-600">
                            You're logged in to the Sports Tournament Management System.
                        </p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="bg-blue-50 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h4 class="text-lg font-medium text-gray-900">Tournaments</h4>
                                    <p class="text-sm text-gray-600">Manage tournaments</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-green-50 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h4 class="text-lg font-medium text-gray-900">Teams</h4>
                                    <p class="text-sm text-gray-600">Manage teams</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-purple-50 rounded-lg p-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h4 class="text-lg font-medium text-gray-900">Matches</h4>
                                    <p class="text-sm text-gray-600">View matches</p>
                                </div>
                            </div>
                        </div>
                    </div>
