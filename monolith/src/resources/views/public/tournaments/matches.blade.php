...
@section('title', $tournament->name . ' - Matches')
...
@include('public.partials.filters', [
    'action' => route('tournaments.matches', $tournament),
    'round' => true,
    'rounds' => $rounds ?? [],
    'status' => true,
    'search' => true,
    ...
    <div class="container mx-auto px-4">
        ...
        @else
            @include('public.partials.empty-state', [
                ...
                'message' => request()->hasAny(['search', 'round', 'status'])
                    ? 'Try adjusting your filters or clear all filters'
                    : 'No matches have been scheduled yet.',
                'action_text' => request()->hasAny(['search', 'round', 'status']) ? 'clear all filters' : null,
                'action_url' => request()->hasAny(['search', 'round', 'status']) ? route('tournaments.matches', $tournament) : null
            ])
        @endif
    </div>
</section>
